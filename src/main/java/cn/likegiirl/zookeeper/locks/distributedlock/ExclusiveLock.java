package cn.likegiirl.zookeeper.locks.distributedlock;
...
public class ExclusiveLock implements DistributedLock {
    ...
    public ExclusiveLock() throws InterruptedException, IOException {
        zooKeeper = new ZooKeeper("192.168.1.121:2181,192.168.1.122:2181,192.168.1.123:2181", 1000, new LockNodeWatcher());
