package cn.likegiirl.zookeeper.locks;

import cn.likegiirl.utils.ThreadPoolManager;
...
public class LockTest {
    ...
    private String zkQurom = "118.89.144.30:2181,193.112.133.164:2181,111.231.93.233:2181";

    private String lockNameSpace = "/mylock";

    private String nodeString = lockNameSpace + "/test1";

    private LockTest mainLock;
