package cn.likegiirl.zookeeper.api.cluster;
...
public class Test {
	...
	/** zookeeper地址 */
	static final String CONNECT_ADDR = "118.89.144.30:2181,193.112.133.164:2181,111.231.93.233:2181";
	/** session超时时间 */
...
//		zk.create("/super", "hello wold".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
